...
export const getMotivationalMessage = (
  ...
  if (caloriesConsumed === 0 && activeMinutes === 0) {
    return {
      text: "Ready to crush today? Start logging!",
      emoji: "💪",
    };
  }
  ...
  if (percentage > 100) {
    return {
      text: "Over limit, but tomorrow is a new day!",
      emoji: "🌅",
    };
  }
  ...
  if (percentage >= 80) {
    return {
      text: "Almost at your limit, stay mindful!",
      emoji: "⚡",
    };
  }
  ...
  if (activeMinutes >= 30) {
    return {
      text: "Great workout today! Keep it up!",
      emoji: "🔥",
    };
  }
